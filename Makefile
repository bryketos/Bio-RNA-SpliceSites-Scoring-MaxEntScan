...
#     ABSTRACT_FROM => q[lib/Bio/RNA/SpliceSites/Scoring/MaxEntScan.pm]
#     AUTHOR => [q[Brian Sebastian Cole <bryketos@cpan.org>]]
...
MAKE = make
FULLEXT = Bio/RNA/SpliceSites/Scoring/MaxEntScan
BASEEXT = MaxEntScan
PARENT_NAME = Bio::RNA::SpliceSites::Scoring
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Bio/RNA/SpliceSites/Scoring/MaxEntScan.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Bio/RNA/SpliceSites/Scoring
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Bio/RNA/SpliceSites/Scoring
